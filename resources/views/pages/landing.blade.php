...
@section('content')
    <main id="main" class="main main-landing">
        <div class="position-relative overflow-hidden p-5 p-md-5 text-white bg-light bimage" style="background-image:url({{ asset('img/ea.jpg') }}); background-repeat: no-repeat; position:relative;background-size:cover; min-height: 800px;">
            <div class="p-lg-3 my-5 judul">
                <h1 class="display-5 fw-bold text-border">Ci Lelang</h1>
                <blockquote class="blockquote">
                    <p class="lead fw-normal mt-3" style="color:#055E68; text-shadow: 0 0 10px rgba(0, 0, 0, 0.2)">Lelang Mudah, Aman, dan Terpercaya.</p>
                </blockquote>
                <a class="btn btn-sm text-white" href="{{ url('/gallery') }}" style="background-color: #A0D8B3 ;border-radius: 20px; box-shadow: 0 0 10px rgba(0, 0, 0, 0.2)">Mulai Lelang</a>
                <figure class="text-end">
                    <blockquote class="blockquote">
                        <p>Everyone can Bid.</p>
                    </blockquote>
                    <figcaption class="blockquote-footer">
                        <cite title="Source Title" style="color:#ffffff">Ci Lelang</cite>
                    </figcaption>
                </figure>
            </div>
            </div>
        ...
        <div>
            <h2 class="position-relative overflow-hidden text-center mt-5">Kilas Lelang</h2>
                                ...
                                <div class="row g-0">
                                    ...
                                    <div class="col-md-7">
                                        <div class="card-body">
                                            ...
                                            <div class="btn-group">
                                                @if (Auth::check())
                                                    <a href="{{ url('gallery/'.$product1->id) }}" type="button" class="btn btn-sm text-white" style="background-color: #A0D8B3; border-radius:20px">Ikut Lelang</a>
                                                @else
                                                    <a href="{{ url('/login') }}" type="button" class="btn btn-sm text-white" style="background-color: #A0D8B3; border-radius:20px">Ikut Lelang</a>
                                                @endif
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row g-0">
                                    ...
                                    <div class="col-md-7">
                                        <div class="card-body">
                                            ...
                                            <div class="btn-group">
                                                @if (Auth::check())
                                                    <a href="{{ url('gallery/'.$product2->id) }}" type="button" class="btn btn-sm text-white" style="background-color: #A0D8B3; border-radius:20px">Ikut Lelang</a>
                                                @else
                                                    <a href="{{ url('/login') }}" type="button" class="btn btn-sm text-white" style="background-color: #A0D8B3; border-radius:20px">Ikut Lelang</a>
                                                @endif
                                            </div>
                                    ...
                                    <div class="col-md-7">
                                        <div class="card-body">
                                            <h5 class="card-title">{{ $product3->nama_barang }}</h5>
                                                ...
                                                <div class="btn-group">
                                                    @if (Auth::check())
                                                        <a href="{{ url('gallery/'.$product3->id) }}" type="button" class="btn btn-sm text-white" style="background-color: #A0D8B3; border-radius:20px">Ikut Lelang</a>
                                                    @else
                                                    <a href="{{ url('/login') }}" type="button" class="btn btn-sm text-white" style="background-color: #A0D8B3; border-radius:20px">Ikut Lelang</a>
                                                @endif
                                            </div>
        ...
        {{-- <div class="px-3 py-1 my-1 text-center">
            ...
            <div class="col-lg-6 mx-auto">
                <p class="lead mb-4">Ci Lelang merupakan website lelang online yang ideal bagi semua orang untuk menemukan barang-barang impian mereka dengan mudah, aman, dan efisien.</p>
